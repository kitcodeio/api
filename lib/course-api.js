        ...
        usercourse: async (request, reply) => {
          ...
          if (result.entity !== null) {
            ...
            if (request.query.id) {
              ...
              if (userCourse.entity == 1) result.entity.statusCode = 'purchased';
              else result.entity.statusCode = 'not purchased'
            } else {
              result.entity.statusCode = 'auth required'
            }
          } else result = {
	    statusCode: 404,
