...
router.post('/create/api/Subdomain', api.create.subdomain);
...
router.get('/read/api/Subdomain', api.read.subdomain);
router.get('/read/api/Container', api.read.container);
...
router.get('/read/course/one/Course/:id', course.study.one.usercourse);
...
router.get('/search/course', course.search);
router.get('/course/signup/:id', course.signup);
