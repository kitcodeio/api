...
module.exports = (config, stat) => {
  ...
  return {
    async generateDockerFile(id) {
      return new Promise(async (resolve, reject) => {
        try {
          ...
          let command = {};
          if (modules.statusCode !== 200) return;
          let cmd = 'FROM kide\nRUN apt-get update';
          modules.entity.forEach(module => {
    ...
    async buildImage(id, user_id, dockerfile, clients, tutorial_id) {
